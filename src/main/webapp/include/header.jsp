...
<body>
	...
	<div id="menu">
	<ul>
		<li><a href="/birdie/memberList.member">회원관리</a></li>
		<li><a href="/birdie/noticeList.notice">공지사항</a></li>
		<li><a href="/birdie/qnaList.qna">Q&A</a></li>
		<li><a href="/birdie/reservationList.reservation">예약관리</a>
		<li><a href="/birdie/rankingList.ranking">랭킹보기</a></li>
	</ul>
</div>
